        ...
        && $checkedUserSettings['kpsUserRequirementRegistration'] === 'true')
    {
        ...
        $output .= '<div>
                        <div style="text-align: center;">
                            <h6>' . esc_html(__('Du musst dich registieren, um Kontaktdaten anzufordern!', 'kps')) . '</h6>
                        </div>
                        <div style="text-align: center;">
    ...
    else
    {
            ...
            && $captchaValid === true)
        {
            ...
            if ($verify->show_isSend())
            {
                ...
                $output = kps_messagebox(esc_html(__('Verifzierung versendet!', 'kps')), $messageboxContent);
            }
            ...
            elseif ($verify->show_isSend() === false && $verify->show_isInsertDB() === false )
            {
                ...
                $outputmessage = kps_messagebox(esc_html(__('Fehler! Datenbankverbindung gestört!', 'kps')) , $messageboxContent);
            ...
            else
            {
                ...
                $output = kps_messagebox(esc_html(__('Fehler! Verifzierung konnte nicht versendet werden!', 'kps')), $messageboxContent);
            }
                ...
                && isset($_POST['submit']))
        {
            ...
            $messageboxContent = '
            <ul>
                <li>' . esc_html(__('Die eingegebene Email-Adresse ist ungültig!', 'kps')) . '</li>
