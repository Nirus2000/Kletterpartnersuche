                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                <div class="kps-message" style="text-align: center;"><b>' . esc_html(__('Eintrag melden', 'kps')) . '!</b></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kps-divTableRow">
                                            ...
                                            <div class="kps-divTable">
                                            	<div class="kps-divTableBody">
                                            		<div class="kps-divTableRow">
                                            			...
                                            			<div class="kps-divTableCell" style="text-align: left; width: 60%;"><label for="kps_reportEntry0">&#160;' . esc_html(__('Werbung/Spam', 'kps')) . '</label></div>
                                            		</div>
                                            		<div class="kps-divTableRow">
                                            			...
                                            			<div class="kps-divTableCell" style="text-align: left; width: 60%;"><label for="kps_reportEntry1">&#160;' . esc_html(__('Unangemessen/Gewalt', 'kps')) . '</label></div>
                                            		</div>
                                            		<div class="kps-divTableRow">
                                            			...
                                            			<div class="kps-divTableCell" style="text-align: left; width: 60%;"><label for="kps_reportEntry2">&#160;' . esc_html(__('Doppelter Eintrag', 'kps')) . '</label></div>
                                            		</div>
                                            		<div class="kps-divTableRow">
                                            			...
                                            			<div class="kps-divTableCell" style="text-align: left; width: 60%;"><label for="kps_reportEntry3">&#160;' . esc_html(__('Persönlichkeitsrechte', 'kps')) . '</label></div>
                                            		</div>
                                            		<div class="kps-divTableRow">
                                            			...
                                            			<div class="kps-divTableCell" style="text-align: left; width: 60%;"><label for="kps_reportEntry4">&#160;' . esc_html(__('Sonstiges', 'kps')) . '</label></div>
                                            		</div>
                                            	</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                ...
                                                <input class="submit" type="submit" name="submit" value="' . esc_html(__('Eintrag melden', 'kps')) . '!">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="kps-divTable">
                                <div class="kps-divTableBody">
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                <div class="kps-message" style="text-align: center;"><b>' . esc_html(__('Kontaktdaten versenden', 'kps')) . '</b></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kps-divTableRow">
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                <label for="kps_RequirementPassword">' . esc_html(__('Passwort', 'kps')) . '</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                ...
                                                <input class="form_field" style="text-align: center;" id="kps_RequirementPassword" name="kps_RequirementPassword" placeholder="' . esc_html(__('Passwort', 'kps')) . '" size="30" aria-required="true" required="required" type="text">
                                            </div>
                                        </div>
                                    </div>';
        // Wenn Captcha aktiviert ist
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                ...
                                                <input class="submit" type="submit" name="submit" value="' . esc_html(__('Anforderung', 'kps')) . '!">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="kps-divTable">
                                <div class="kps-divTableBody">
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                <div class="kps-message" style="text-align: center;"><b>' . esc_html(__('Kontaktdaten anfordern', 'kps')) . '!</b></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kps-divTableRow">
                            ...
                            <div class="kps-divTable">
                                <div class="kps-divTableBody">
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                <div class="kps-message" style="text-align: center;"><b>' . esc_html(__('Eintrag aktivieren', 'kps')) . '</b></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kps-divTableRow">
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                ...
                                                <input class="submit" type="submit" name="submit" value="' . esc_html(__('Eintrag aktivieren', 'kps')) . '!">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="kps-divTable">
                                <div class="kps-divTableBody">
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                <div class="kps-message" style="text-align: center;"><b>' . esc_html(__('Eintrag löschen', 'kps')) . '</b></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                ...
                                                <input class="form_field" style="text-align: center;" id="kps_DeletePassword" name="kps_DeletePassword" placeholder="' . esc_html(__('Passwort', 'kps')) . '" size="30" aria-required="true" required="required" type="text">
                                            </div>
                                        </div>
                                    </div>';
        // Wenn Captcha aktiviert ist
                                     ...
                                     <div class="kps-divTableRow">
                                        <div class="kps-divTableCell">
                                            <div class="kps-message" style="text-align: center;">
                                                ...
                                                <input class="submit" type="submit" name="submit" value="' . esc_html(__('Eintrag löschen', 'kps')) . '!">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
if ( !function_exists( 'kps_template' ) ) {
    function kps_template( $entry ) {
        ...
        {
            $userReport = '<a class="kps-entry-moderate" href="' . $pageUrl . '&kps_report=' . $entry->show_id() . '" title="' . esc_html(__( 'Eintrag melden', 'kps' )) . '">' . esc_html(__( 'Eintrag melden', 'kps' )) . '</a><span>&#160;&#160;</span>';
        }

        // Anforderung der Kontaktdaten
        $requirement = '<a class="kps-entry-moderate" href="' . $pageUrl . '&kps_data=' . $entry->show_id() . '" title="' . esc_html(__( 'Kontaktdaten anfordern', 'kps' )) . '">' . esc_html(__( 'Kontaktdaten anfordern', 'kps' )) . '</a><span>&#160;&#160;</span>';

        // Sofortbearbeitung für Moderatoren
        if (function_exists('current_user_can') && current_user_can( 'moderate_comments'))
        {
            // Ausgabe Bearbeitung
            $moderate = '<a class="kps-entry-moderate" href="' . KPS_ADMIN_URL . '/entries.php&edit_id=' . $entry->show_id() . '" title="' . esc_html(__( 'Bearbeiten', 'kps' )) . '">' . esc_html(__( 'Bearbeiten', 'kps' )) . '</a>';
        }
        ...
        if ($entry->show_isFound() === true)
        {
            ...
            // Ausgabe Zeitstempel + Anforderung + Moderation
            $output .= '
            <div class="kps-entry">
                <div class="kps-divTable">
                	<div class="kps-divTableBody">
