                        ...
                        <form id="kps-new-entry" class="' . $formClass . '" action="" method="post">
                            ...
                            <div class="kps-divTable">
                                <div class="kps-divTableBody">
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell kps-nobr"><label for="kps_authorSearchfor">' . esc_html(__('Ich suche für', 'kps')) . '&#160;<sup><span class="kps-required">*</span></sup></label></div>
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell kps-nobr"><label for="kps_authorRule">' . esc_html(__('Art der Suche', 'kps')) . '&#160;<sup><span class="kps-required">*</span></sup></label></div>
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell kps-nobr"><label for="kps_yourRule">' . esc_html(__('Ich bin', 'kps')) . '&#160;<sup><span class="kps-required">*</span></sup></label></div>
                                        <div class="kps-divTableCell">
                                    ...
                                    <div class="kps-divTableRow">
                                        <div class="kps-divTableCell kps-nobr" style="vertical-align: top;"><label for="kps_authorEntry">' . esc_html(__('Eintrag', 'kps')) . '&#160;<sup><span class="kps-required">*</span></sup></label></div>
        ...
        if ($checkedUserSettings['kpsUserPrivacyAGB'] === 'true' OR $checkedUserSettings['kpsUserPrivacyDSGVO'] === 'true')
        {
            ...
            $output .= '
                        ...
                        <div class="kps-form-info" style="display: inline-block; margin: 0; padding: 0; line-height: 1.2em;">
                            <ul>
                                <li><sup><span class="kps-required">*</span></sup>&#160;' . esc_html(__('Pflichtfelder', 'kps')) . '</li>
