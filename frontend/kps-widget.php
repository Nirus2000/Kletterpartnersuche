...
class Kletterpartner_Suche extends WP_Widget {
    ...
    function __construct()
    {
		$widgetOptions = array(
    			             ...
    			             'description'   => esc_html(__('Zeigt die letzten Einträge in der Kletterpartner-Suche.', 'kps')),
        );
        parent::__construct( 'Kletterpartner_Suche', esc_html(__('Kletterpartner-Suche', 'kps')).':', $widgetOptions );
    ...
    function widget($args, $instance)
    {
        ...
        //var_dump($args);
        extract($args);
        $defaultValues = array( 'title'         =>  esc_html(__('Kletterpartner-Suche', 'kps')),
                                'showEntries'   =>  3,
                                'linktext'      =>  esc_html(__('Mehr lesen...', 'kps'))
        );
        ...
        else
        {
            ...
            $output .= esc_html(__('Keine Einträge vorhanden!', 'kps'));
        }
    ...
    function form($instance)
    {
        ...
        */
        ...
        echo '
                    ...
                    <label for="' . $this->get_field_name('showEntries'). '">' . esc_html(__('Anzahl der Einträge', 'kps')) . ':</label><br />
