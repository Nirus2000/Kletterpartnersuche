...
between 1-499 messages. The range up to the automatic lock is between 2-500 messages.', 'kps') . '.</h5>
                <form class="form" action="" method="post">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td><label for="kpsAdminSendReportAfter">' . esc_html__('Total Message-Reporting', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsReportSpam">' . esc_html__('Spam/Advertising', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsAutoReportSpam">' . esc_html__('Automatic-Lock after', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsReportUnreasonable">' . esc_html__('Inappropriate/Violence', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsAutoReportUnreasonable">' . esc_html__('Automatic-Lock after', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsReportDouble">' . esc_html__('Double entry', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsAutoReportDouble">' . esc_html__('Automatic-Lock after', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsReportPrivacy">' . esc_html__('Personality rights', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsAutoReportPrivacy">' . esc_html__('Automatic-Lock after', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsReportOthers">' . esc_html__('Others', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsAutoReportOthers">' . esc_html__('Automatic-Lock after', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label class="labelCheckbox" for="kpsReportActivation">' . esc_html__('Automatic-Lock enable', 'kps') . '</label></td>
...
function kps_Optionfields()
{
    ...
    echo '
            <div class="kps_container" style="width: 33%"><h5>' . esc_html__('Setting the input options, which information the author, the requestor, makes available for contacting.', 'kps') . '</h5>
                <form class="form" action="" method="post">
                    <table class="table" cellpadding="5" cellspacing="5">
                        <tbody>
                            <tr>
                                <td colspan="6"><u>' . esc_html__('Direct Contact', 'kps') . '</u></td>
                            </tr>
                            <tr>
                                <td width="25"><input type="checkbox" name="kpsFormOptionMobile" id="kpsFormOptionMobile" value="1" ' . $checkedFormOptionMobile . ' /></td>
                                <td width="33%"><label class="labelCheckbox" for="kpsFormOptionMobile">' . esc_html__('Mobile Phone', 'kps') . '</label></td>
                                ...
                                <td width="33%"><label class="labelCheckbox" for="kpsFormOptionTelephone">' . esc_html__('Telephone', 'kps') . '</label></td>
                                <td width="25"></td>
                                <td width="33%"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="6"><u>' . esc_html__('Messenger-Services', 'kps') . '</u></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="33%"><label class="labelCheckbox" for="kpsFormOptionInstagram">' . esc_html__('Instagram', 'kps') . '</label></td>
                                <td width="25"><input type="checkbox" name="kpsFormOptionWebsite" id="kpsFormOptionWebsite" value="1" ' . $checkedFormOptionWebsite . ' /></td>
                                <td width="33%"><label class="labelCheckbox" for="kpsFormOptionWebsite">' . esc_html__('Website', 'kps') . '</label></td>
                            </tr>
                            <tr>
...
function kps_UserSettings()
{
    ...
    echo '
            <div class="kps_container" style="width: 33%"><h5>' . esc_html__('Settings for the form and the output itself.', 'kps') . '</h5>
                <form class="form" action="" method="post">
                    <table class="table" cellpadding="5" cellspacing="5">
                        <tbody>
                            <tr>
...
as well as in the output (frontend). The range can be set between 1-99 entries per page.', 'kps') . '.</h5>
                <form class="form" action="" method="post">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td><label for="kpsBackendPagination">' . esc_html__('Adminpanel', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsFrontendPagination">' . esc_html__('Output frontend', 'kps') . '</label></td>
...
for communication between your website and Google. Keep the key secret. You can sign in under:', 'kps') .
                ...
                <form class="form" action="" method="post">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td><label for="kpsCaptchaSiteKey">' . esc_html__('Site-Key', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsCaptchaSecretKey">' . esc_html__('Secret-Key', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label class="labelCheckbox" for="kpsCaptchaActivated">' . esc_html__('Google reCaptcha enable', 'kps') . '</label></td>
...
Administrator. Additional information about the activities can be retrieved.', 'kps') . '</h5>
                <form class="form" action="" method="post">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td><label for="kpsMailFrom">' . esc_html__('Email', 'kps') . '</label></td>
                            ...
                            <tr>
                                <td><label for="kpsEmailCC">' . esc_html__('Email copy', 'kps') . '</label></td>
                                <td><input type="email" name="kpsEmailCC" id="kpsEmailCC" autocomplete="off" class="form_field" value="' . esc_attr($checked['kpsEmailCC']) . '"  /></td>
                            </tr>
                            <tr>
                                <td><label for="kpsEmailReport">' . esc_html__('Report-Email', 'kps') . '</label></td>
                           ...
                           <tr>
                                <td><label class="labelCheckbox" for="kpsEmailInformation">' . esc_html__('Information', 'kps') . '</label></td>
