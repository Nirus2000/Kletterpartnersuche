      ...
      <div id="kps" class="wrap kps">
            ...
            <h2 class="nav-tab-wrapper kps_nav_tab_wrapper">
    			<a href="" class="nav-tab <?php if ($kps_tab == 'kps_AgbSetting') { echo "nav-tab-active";} ?>" rel="kps_AgbSetting">
                    <div style="text-align: center;"><?php  esc_html_e('Allgemeine Geschäftsbedingungen', 'kps'); ?></div>
                </a>
    			<a href="" class="nav-tab <?php if ($kps_tab == 'kps_DsgvoSetting') { echo "nav-tab-active";} ?>" rel="kps_DsgvoSetting">
                    <div style="text-align: center;"><?php  esc_html_e('Datenschutz-Grundverordnung', 'kps'); ?></div>
                </a>
    		</h2>
        ...
        if ($verification == true)
        {
            ...
            if (is_numeric($setAGBPage))
            {
                ...
                <div class="notice notice-success is-dismissible">
                	<p><strong>' .  esc_html(__('Gespeichert', 'kps')) . ':&#160;' .  esc_html(__('Allgemeine Geschäftsbedingungen', 'kps')) . '</strong></p>
                ...
                if (empty($setAGBPage))
                {
                    ...
                    <div class="notice notice-warning is-dismissible">
                    	<p><strong>' .  esc_html(__('Warnung', 'kps')) . ':&#160;' . esc_html(__('Keine Allgemeine Geschäftsbedingungen ausgewählt', 'kps')) . '</strong></p>
                    	<button type="button" class="notice-dismiss">
                    		<span class="screen-reader-text">Dismiss this notice.</span>
                    	</button>
                    </div>
    ...
    echo '                      </td>
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <input class="button-primary" type="submit" name="submitAGB" value="' . esc_html(__('Speichern', 'kps')) . '" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    if (isset($_POST['submitDSGVO']))
    {
        ...
        if ($verification == true && isset($_POST['submitDSGVO']))
        {
            ...
            if (is_numeric($setDSGVOPage))
            {
                ...
                echo '
                <div class="notice notice-success is-dismissible">
                	<p><strong>' .  esc_html(__('Gespeichert', 'kps')) . ':&#160;' .  esc_html(__('Datenschutz-Grundverordnung', 'kps')) . '</strong></p>
                	<button type="button" class="notice-dismiss">
                		<span class="screen-reader-text">Dismiss this notice.</span>
                	</button>
                </div>
                ...
                if (empty($setDSGVOPage))
                {
                    echo '
                    <div class="notice notice-warning is-dismissible">
                    	<p><strong>' .  esc_html(__('Warnung', 'kps')) . ':&#160;' . esc_html(__('Keine Datenschutz-Grundverordnung ausgewählt', 'kps')) . '</strong></p>
                    	<button type="button" class="notice-dismiss">
                    		<span class="screen-reader-text">Dismiss this notice.</span>
                    	</button>
                    </div>
    ...
    echo '                      </td>
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <input class="button-primary" type="submit" name="submitDSGVO" value="' . esc_html(__('Speichern', 'kps')) . '!" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
