...
class kps_verify
{
    ...
    public function sendEmail($id = '', $email = '', $pageUrl='')
    {
        ...
        {
            $verifySubject = esc_html(__('Verifizierung', 'kps'));
            $verifyContent = esc_html(__('Sie möchten die Kontaktdaten für folgenden Eintrag.
...
%blogemail%', 'kps'));
        ...
        // Email versenden
        $this->_isSend = wp_mail(esc_attr($email), $verifySubject, $verifyContent);
